...
params = {
    ...
    'eval_metric': 'logloss',  # 使用 logloss 作為評估指標
...
plt.legend()
plt.savefig(os.path.join(output_dir, "xgb_logloss_curve.png"))
...
loss_df.to_csv(os.path.join(output_dir, "xgb_logloss.csv"), index=False)
